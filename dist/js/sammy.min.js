var app=angular.module("Sammy-gui",["ui.bootstrap","ui.router","ngCookies"]).filter("secondsToDateTime",[function(){return function(e){return new Date(1970,0,1).setSeconds(e)}}]).filter("underscoreToSpace",function(){return function(e){return e.replace(/_/g," ")}});
...
function CpuCtrl(t,e,n,a,o){t.temps=[],t.getCpuTemp=function(){e.get(a.url+"/cpu/temp").success(function(e,n,a,o){t.temps.length>=60&&t.temps.shift(),t.temps.push(e.temperatures),t.cputemploading=!1}).error(function(t,e,n,a){o.addAlert("danger","fa-exclamation-triangle","Can't fetch CPU temperatures")})},t.getCpuLoad=function(){e.get(a.url+"/cpu/load").success(function(e,n,a,o){t.load=e,t.loadloading=!1}).error(function(t,e,n,a){o.addAlert("danger","fa-exclamation-triangle","Can't fetch CPU load")})},t.loading=!0,e.get(a.url+"/cpu/info").success(function(e,n,a,o){t.cpuinfo=e,t.loading=!1}).error(function(t,e,n,a){o.addAlert("danger","fa-exclamation-triangle","Can't fetch CPU information")}),t.cputemploading=!0,t.getCpuTemp(),n(t.getCpuTemp,1e3),t.loadloading=!0,t.getCpuLoad(),n(t.getCpuLoad,5e3)}app.controller("CpuCtrl",["$scope","$http","$interval","Config","Alert",CpuCtrl]);
...
function MemCtrl(e,n,o,r){e.memoryloading=!0,n.get(o.url+"/mem").success(function(n,o,r,t){e.meminfo=n,e.memoryloading=!1}).error(function(e,n,o,t){r.addAlert("danger","fa-exclamation-triangle","Can't fetch memory information")})}app.controller("MemCtrl",["$scope","$http","Config","Alert",MemCtrl]);
