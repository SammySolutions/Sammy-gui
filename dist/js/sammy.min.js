...
function MemCtrl(e,t,a,m,o){e.memoryloading=!0,t.get(m.url+"/mem").success(function(t,a,m,o){e.meminfo=t,e.memoryloading=!1}).error(function(e,t,a,m){o.addAlert("danger","fa-exclamation-triangle","Can't fetch memory information")}),e.getMemLoad=function(){t.get(m.url+"/mem/load").success(function(t,a,m,o){e.memLoad=t,e.currentPercentage=e.memLoad["Mem:"].used.slice(0,-1)/e.memLoad["Mem:"].total.slice(0,-1)*100,e.currentSwapPercentage=e.memLoad["Swap:"].used.slice(0,-1)/e.memLoad["Swap:"].total.slice(0,-1)*100}).error(function(e,t,a,m){o.addAlert("danger","fa-exclamation-triangle","Can't fetch memory load")})},e.getMemLoad(),a(e.getMemLoad,1e3)}app.controller("MemCtrl",["$scope","$http","$interval","Config","Alert",MemCtrl]);
