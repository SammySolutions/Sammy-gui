...
function HeaderCtrl(t,e,r,o,a){t.update=function(){var e=r.url();switch(e){case"/mem":t.currentPage="Memory information";break;case"/cpu":t.currentPage="Processor information";break;default:t.currentPage="Dashboard"}t.crumbs=[],t.crumbs=e.split("/")},t.shutdown=function(){a.get(o.url+"/system/shutdown")},t.reboot=function(){a.get(o.url+"/system/reboot")},t.update(),e.$on("$stateChangeStart",function(e,r,o,a,n){t.update()})}app.controller("HeaderCtrl",["$scope","$rootScope","$location","Config","$http",HeaderCtrl]);
